...
open (NFILE, $n_file =~ /\.gz$/? "gzip -dc $n_file |" : $n_file =~ /\.xz$/? "xz -dc $n_file |" : $n_file) || die "I can't open node file $n_file\n";
open (IFILE, $i_file =~ /\.gz$/? "gzip -dc $i_file |" : $i_file =~ /\.xz$/? "xz -dc $i_file |" : $i_file) || die "I can't open pl   file $i_file\n";
open (PFILE, $p_file =~ /\.gz$/? "gzip -dc $p_file |" : $p_file =~ /\.xz$/? "xz -dc $p_file |" : $p_file) || die "I can't open sol  file $p_file\n";
open (SFILE, $s_file =~ /\.gz$/? "gzip -dc $s_file |" : $s_file =~ /\.xz$/? "xz -dc $s_file |" : $s_file) || die "I can't open scl  file $s_file\n";
